import { ChangeDetectorRef, Injector, Injectable, Input, Type } from '@angular/core';
import { ControlValueAccessor } from '@angular/forms';

@Injectable()
export abstract class NgModelComponent<T = any, U = T> implements ControlValueAccessor {
  protected _value!: T;
